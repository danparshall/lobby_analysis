...
`docs/historical/pri-calibration/results/20260419_pri_rollup_rule_spec.md` and every
...
def _disclosure_scores_path(repo_root: Path) -> Path:
    return repo_root / "docs" / "historical" / "pri-2026-rescore" / "results" / "pri_2010_disclosure_law_scores.csv"


def _accessibility_scores_path(repo_root: Path) -> Path:
    return repo_root / "docs" / "historical" / "pri-2026-rescore" / "results" / "pri_2010_accessibility_scores.csv"
