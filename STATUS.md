...
Scoping phase: prior-art survey, state infrastructure profiling, and Open Civic Data schema analysis on the `research-prior-art` branch. Not yet writing pipeline code — the decision is to depend on Open States (not fork) and adopt Popolo via OCDEP 5 plus Epton's draft Campaign Finance Filings pattern, but several schema-design questions are still open (see `docs/active/research-prior-art/results/schema-design-questions.md`).

## Active Research Lines

| Branch | Started | Focus | Status |
|--------|---------|-------|--------|
| research-prior-art | 2026-04-10 | Prior-art survey, state infrastructure tiers, OCD schema analysis, schema-design questions | In progress — first convo committed; paper ingestion partially complete (2 of 7 candidates); 5 deferred to next session |
