...
CHUNKS_V2: tuple[ChunkDef, ...] = (
    ...
    ChunkDef(
        ...
        notes="Contains 2 of the 5 combined-axis rows (`lobbyist_registration_required`, `lobbyist_registration_deadline_days_after_first_lobbying`). Mixed axis_summary expected.",
    ),
    ChunkDef(
