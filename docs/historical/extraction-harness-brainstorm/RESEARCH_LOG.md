...
> **Archived 2026-05-24** as part of the Prong 1 pause + gather-first / v2.2 pivot. This branch's Tier-1 / Tier-2 pilot work on OH 2025 directly drove the pivot decision (Tier-2 Step D writeup: *"model right, schema can't represent the answer"*). The reasoning trajectory for the pivot is captured in [`convos/20260524_prong_1_pivot_reasoning.md`](convos/20260524_prong_1_pivot_reasoning.md). See `README.md` "Research question" section + `docs/RESEARCH_ARC.md` "Status: Prong 1 paused" header for the project-level framing.
>
