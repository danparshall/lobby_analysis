...
|---|---|---|---|---|---|
| **Opheim 1991** | 1991 (received Dec 1989; accepted Apr 1990) | **1988-89** | Paper line 121-124: "from the Council of State Government's Blue Book 1988-89" + "Council of State Governments, The Book of the States, 1988-89" + "data are gathered from Council of State Governments, 1988, pp. 97-99" | **HIGH** — paper-explicit | ~~Fetch 1988-89 statute snapshots for 47 in-scope states (MT, SD, VA excluded by Opheim).~~ **2026-05-18: 1988-89 statute data does not appear to be online from sources we've found** (Justia, state code repos, standard online sources). End-to-end weak-inequality validation against Opheim's Table 1 totals is therefore **not currently executable**. Per-item helpers can be implemented as stable code (cells get populated if/when data appears) but the calibration step is blocked until a 1988-89 archive surfaces. Likely belongs to a Track A retrieval scope-expansion conversation. See `plans/20260514_opheim_1991_plan.md` header banner. |
...
| **Sunlight 2015** | Aug 12, 2015 | **~early-to-mid 2015 statutes and portals** | Paper line 242 ("Kansas chooses not to hold any lobbying data before 2015 on its website") is only sensible as a *researcher-side* observation made while browsing in 2015 — strong implicit lower bound. Methodology section (lines 128-156): "We relied upon both the legal statutes and data provided on a state's website when determining the grade." No explicit "research conducted in X month" sentence. Publication: Aug 12, 2015. | **MEDIUM** — Kansas line is a strong implicit signal that the researcher was browsing in 2015; still not HIGH because the paper never names an explicit research period. (Re-read 2026-05-18 during Sunlight Phase 0.) | Statute snapshots **as of early-to-mid 2015** (overlap with SII window). User's Sub-0 framing — "wasn't actually checking the 2015 statutes, it was probably 2014" — partially negated by the Kansas line, which firms the lower bound at 2015. |
...
Two rubrics still have MEDIUM-or-lower data-year confidence (PRI 2010, Newmark 2017) after the 2026-05-18 Sunlight re-read lifted Sunlight to MEDIUM. CPI 2015 was already MEDIUM at draft time. Sub-1 / Sub-2 / Sub-3 plan-drafting agents should:

1. ~~**Sunlight 2015**: read paper methodology section (`Sunlight_2015__state_lobbying_disclosure_scorecard.txt`) end-to-end during Sunlight plan drafting; flag exact research period.~~ **Done 2026-05-18 (Sunlight TDD Phase 0):** methodology section (lines 128-156) does not name a research period explicitly; the strongest implicit signal is line 242 ("Kansas chooses not to hold any lobbying data before 2015 on its website") which is only sensible from inside-2015. Confidence lifted MEDIUM-LOW → MEDIUM.
