...
> **Executed 2026-05-14.** This sketch was the brainstorm agenda; it has been executed. The "real" brainstorm session is captured at [`../convos/20260514_extraction_harness_brainstorm.md`](../convos/20260514_extraction_harness_brainstorm.md) (Phase 1 reading + Phase 2 decisions on the 6 architectural questions + a new Q0 surfaced by Phase 1 reading). Output: [`20260514_v2_pydantic_cell_models_implementation_plan.md`](20260514_v2_pydantic_cell_models_implementation_plan.md) — the TDD-shaped first-component plan this sketch recommended. **For Phase 2 architectural decisions, read the brainstorm convo (locked rationale) rather than this sketch's open-questions section (provisional).**

**Originating conversation:** [`../convos/20260514_kickoff_orientation.md`](../convos/20260514_kickoff_orientation.md) (which itself is a thin handoff from [`../../../compendium-v2-promote/convos/20260514_compendium_v2_promote.md`](../../../compendium-v2-promote/convos/20260514_compendium_v2_promote.md), now on main post-`compendium-v2-promote` merge `0a6804f`).
