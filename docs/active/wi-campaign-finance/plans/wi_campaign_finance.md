...
**Originating conversation:** [`../../../historical/wi-cfis-scoping/convos/20260603_wi_cfis_access_surface_scoping.md`](../../../historical/wi-cfis-scoping/convos/20260603_wi_cfis_access_surface_scoping.md)

**Originating scoping doc:** [`../../../historical/wi-cfis-scoping/results/20260603_phase_4_cfis_scoping.md`](../../../historical/wi-cfis-scoping/results/20260603_phase_4_cfis_scoping.md)

**Originating sample-query writeup:** [`../../../historical/wi-cfis-scoping/results/20260603_ftm_sample_query_lemahieu.md`](../../../historical/wi-cfis-scoping/results/20260603_ftm_sample_query_lemahieu.md)

**Carried into this branch:** plan copied 2026-06-04 from `docs/historical/wi-cfis-scoping/plans/wi_campaign_finance.md` after wi-cfis-scoping merged (PR #34, merge `28f3e47`). Relative paths above updated to reflect the historical/ location. The canonical scoping evidence lives in `docs/historical/wi-cfis-scoping/`.
...
**Branch:** `wi-campaign-finance` — cut off post-merge main 2026-06-04 (after wi-cfis-scoping merged via PR #34). Worktree at `/Users/dan/code/lobby_analysis/.worktrees/wi-campaign-finance/` (exists with `data/` symlink to `~/data/lobby_analysis/` and `.env.local` symlink to main).
...
- **Scoping reference (read-only):** `docs/historical/wi-cfis-scoping/` — read the scoping doc + sample-query writeup before any code
...
- **Plan reference:** `docs/active/wi-campaign-finance/plans/wi_campaign_finance.md` (this file; copy of the original at `docs/historical/wi-cfis-scoping/plans/wi_campaign_finance.md`)
...
3. **When it arrives**, reply with the context drafted in [`../../../historical/wi-cfis-scoping/results/20260603_ftm_sample_query_lemahieu.md`](../../../historical/wi-cfis-scoping/results/20260603_ftm_sample_query_lemahieu.md) §6 — Corda Democracy Fellowship + open-source + non-commercial + planned use across 5-8 priority states over the next few weeks + attribution per CC BY-NC-SA 3.0 US.
