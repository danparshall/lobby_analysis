...
2. **"Libgober & Rashin — fuzzylink" is incorrect.** The actual author is **Joe Ornstein (2025)**, *Political Analysis*, "Probabilistic Record Linkage Using Pretrained Text Embeddings." Libgober has a different 2024 paper with Jerzak ("Linking Datasets on Organizations Using Half A Billion Open Collaborated Records," *PSRM*) that is arguably even more relevant since it's specifically about organization linkage.
...
- **Look into Libgober & Jerzak 2024** (organization linkage, PSRM) — possibly more directly relevant than Ornstein's fuzzylink for corporate entity matching.
