...
- **gpt-5-mini validation work:** drafted plan, NOT yet committed to repo. Decision pending: does this displace Day 2 cross-state CPI dispatch from the 5-day plan? FOCAL Plans 3+4 (Day 4) is the natural cut if Dan greenlights mini-validation. Plan name: `20260608_gpt5mini_on_oh_300slice.md` (would live at `docs/active/leave-behind-prep/plans/`).
...
- gpt-5-mini-on-300-slice plan drafted in-session, NOT committed to repo. Awaiting Dan's go/no-go on whether it displaces Day 2.
...
- **gpt-5-mini-on-300-slice — green-light, defer, or drop?** If green-light, Day 2 cross-state CPI dispatch slips; if drop, Suhan decisions doc proceeds with Sonnet-only cost framing. Dan to decide.
